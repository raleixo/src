function [x,y,u,v,SnR,Pkh]=multipassxNOFILTER(im1,im2,wins,Dt,overlap,SubPixMethod,sensit,maske,iter,datax,datay)
...
% Added by Ana Margarida
%SubPixMethod = to define which method will be used in the
%cross-correlation peak determination
...
disp('* Final Pass')
[x,y,u,v,SnR,Pkh]=finalpass(A,B,wins(end,:),overlap,SubPixMethod,round(datax),...
