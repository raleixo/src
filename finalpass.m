function [xp,yp,up,vp,SnR,Pkh]=finalpass(A,B,N,ol,SubPixMethod,idx,idy,Dt,maske)
...
% Changed by Ana Margarida to include SubPixMethod
...
% %                   R(max_y1-1,max_x1),R(max_y1+1,max_x1),SubPixMethod,[M,N]);
              [x0, y0]=intpeak(max_x1,max_y1,R,SubPixMethod,[M,N]);
